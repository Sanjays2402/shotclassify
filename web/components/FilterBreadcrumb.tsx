...
// FilterBreadcrumb: a slim row of removable pills above the shots table that
// shows every active filter ("Class: Receipt", "Tag: #important", "≥85%")
// with an x to clear each one individually, plus a "Clear all" affordance.
// Pairs with lib/filter-summary.ts, which owns the label-building + clear
// logic so this component stays a thin renderer.
