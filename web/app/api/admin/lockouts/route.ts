// Proxy for FastAPI /v1/admin/lockouts. Admin-only on the API side;
// this route forwards cookie or workspace API key + tenant header.
...
export async function GET(req: NextRequest) {
  const r = await fetch(`${API}/v1/admin/lockouts`, {
