// Proxy for FastAPI /v1/admin/overview. The FastAPI side enforces admin
// role and tenant scoping; this route forwards the browser session cookie
// or the workspace API key and relays the response verbatim.
