// Proxy to FastAPI /v1/audit/sinks. Lets workspace admins register HTTPS
// endpoints that receive a signed copy of every audit row, for forwarding
// into Splunk / Datadog / Sumo Logic / any HTTPS log collector.
...
export async function GET(req: NextRequest) {
  const r = await fetch(`${API}/v1/audit/sinks`, {
