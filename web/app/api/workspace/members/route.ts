// Proxy for FastAPI /v1/members.
// The legacy /api/members route uses a local JSON file; this one talks to
// the canonical FastAPI memberships service so the workspace admin UI and
// the rest of the platform agree on who has what role.
